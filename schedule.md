...
Firstly, I dislike the placement of the quit button. It could easily be pressed if your not paying attention, especially when exiting the casino.

Second of all, I dislike how the quit button just instantly closes the game without warning. It should, at the very least, lead you to the title screen to prevent you from having to re-open the game.
